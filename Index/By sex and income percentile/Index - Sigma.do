...
dis as text "With only one retirement age, an error aversion of " as result `=B' as text ", a ponderation of " as result `=s' as text "and a proportion of life spent working " as result `=alpha' as text ", the social planner would set the retirement age at " as result `=alpha' as text " * " as result Retirement_age[1] as text "."
...
dis as text "With one retirement age by sex, an error aversion of " as result `=B' as text ", a ponderation of " as result `=s' as text " and a proportion of life spent working " as result `=alpha' as text ", the social planner would set the retirement age at " as result `=alpha' as text " * " as result Retirement_age_`j'[1] as text "."
}
restore 
}
...
dis as text "With one retirement age by percentile, an error aversion of " as result `=B' as text ", a ponderation of " as result `=s' as text " and a proportion of life spent working " as result `=alpha' as text ", the social planner would set the retirement age at " as result `=alpha' as text " * " as result Retirement_age_`i'[1] as text "."
}
restore
}
...
dis as text "With one retirement age by sex & percentile, an error aversion of " as result `=B' as text ", a ponderation of " as result `=s' as text " and a proportion of life spent working " as result `=alpha' as text ", the social planner would set the retirement age at " as result `=alpha' as text " * " as result Retirement_age_`i'_`j'[1] as text "."
