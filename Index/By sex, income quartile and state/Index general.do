...
dis as text "With one retirement age by state, an error aversion of " as result `=B' as text " and a proportion of life spent working " as result `=alpha' as text ", the social planner would set the retirement age at " as result `=alpha' as text " * " as result Retirement_age_`j'[1] as text "."
}
restore 
}
...
dis as text "With one retirement age by state and by sex, an error aversion of " as result `=B' as text " and a proportion of life spent working " as result `=alpha' as text ", the social planner would set the retirement age at " as result `=alpha' as text " * " as result Retirement_age_`j'_`s'[1] as text "."
}
}
restore 
}
...
dis as text "With one retirement age by state, by quartile and by sex, an error aversion of " as result `=B' as text " and a proportion of life spent working " as result `=alpha' as text ", the social planner would set the retirement age at " as result `=alpha' as text " * " as result Retirement_age_`j'_`s'_`q'[1] as text "."
}
}
}
restore 
